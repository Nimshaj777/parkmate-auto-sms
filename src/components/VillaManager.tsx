...
export function VillaManager({ villas, onAdd, onUpdate, onDelete, isRTL, villaLimit = 1, language }: VillaManagerProps) {
  ...
  const t = {
    en: { 
      villas: 'Villas', villasUsed: 'villas added', addVilla: 'Add Villa', addNewVilla: 'Add New Villa', 
      villaName: 'Villa Name', defaultNumber: 'Default SMS Number', add: 'Add', cancel: 'Cancel', save: 'Save', sms: 'SMS'
    },
    ar: { 
      villas: 'الفيلات', villasUsed: 'فيلا مضافة', addVilla: 'إضافة فيلا', addNewVilla: 'إضافة فيلا جديدة', 
      villaName: 'اسم الفيلا', defaultNumber: 'الرقم الافتراضي', add: 'إضافة', cancel: 'إلغاء', save: 'حفظ', sms: 'رسالة'
    },
    hi: { 
      villas: 'विला', villasUsed: 'विला जोड़े गए', addVilla: 'विला जोड़ें', addNewVilla: 'नया विला जोड़ें', 
